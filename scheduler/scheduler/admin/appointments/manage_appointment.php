    ...
    <div class="row" id="appointment">
        <div class="col-6" id="frm-field">
            ...
            <input type="hidden" name="patient_id" value="<?php echo isset($patient_id) ? $patient_id : '' ?>">
                ...
                <div class="form-group">
                    <label  class="control-label">Patient Contact Number</label>
        ...
        <div class="col-6">
                <div class="form-group">
                    ...
                    <input  list="browsers" class="form-control" placeholder="Select doctor" name="doctor">
            ...
            <?php endif; ?>
            <div class="form-group">
                <label  class="control-label">Complaints & Requirements</label>
...
<script type="text/javascript">
            ...
            $('#timeSchdld').on('change',function(){
                ...
                if(textName == 'Evening'){
                  $('#appendAppoint').html('');
                  $('#appendAppoint').append('<div class="form-group hide" id="evening"> <label  class="control-label">Appointment</label> <input type="text" class="form-control" id="eveningInput"  name="date_sched"  required> </div>');
                $('#morning').hide();
                $('#evening').show();
                }
                if(textName == 'Morning'){
                  $('#appendAppoint').html('');
                $('#appendAppoint').append('<div class="form-group hide" id="morning"> <label  class="control-label">Appointment</label> <input type="text" class="form-control" id="morningInput" name="date_sched" required> </div>');
